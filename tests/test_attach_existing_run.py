...
class TestTrackingConfig:
    ...
    def test_config_wired_to_tracker_via_optimize_anything(self):
        ...
        with (
            patch("gepa.optimize_anything.create_experiment_tracker", side_effect=spy),
            ...
            mock_state.prog_candidate_per_example_scores = [{}]
            mock_state.prog_candidate_per_example_acceptance_scores = [{}]
            mock_state.program_at_pareto_front_valset = {}
            mock_state.program_full_acceptance_scores_val_set = [0.5]
